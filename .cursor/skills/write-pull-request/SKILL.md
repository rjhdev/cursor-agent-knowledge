...
description: Drafts detailed pull request descriptions, explaining changes, providing reasoning, and identifying potential bugs from the git diff command output. Adapted from Fabric pattern `write_pull-request`.
---

# Write Pull Request

Adapted from [danielmiessler/fabric `write_pull-request`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/write_pull-request).

## When to Use

- Use when the `write_pull-request` Fabric workflow fits the task.
- Upstream pattern: [write_pull-request](https://github.com/danielmiessler/fabric/tree/main/data/patterns/write_pull-request)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/write_pull-request/system.md`
