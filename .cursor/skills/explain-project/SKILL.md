...
description: Summarizes project documentation into clear, concise sections covering the project, problem, solution, installation, usage, and examples. Adapted from Fabric pattern `explain_project`.
---

# Explain Project

Adapted from [danielmiessler/fabric `explain_project`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/explain_project).

## When to Use

- Use when the `explain_project` Fabric workflow fits the task.
- Upstream pattern: [explain_project](https://github.com/danielmiessler/fabric/tree/main/data/patterns/explain_project)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/explain_project/system.md`
