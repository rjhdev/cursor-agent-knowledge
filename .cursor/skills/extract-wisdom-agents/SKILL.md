...
description: Extracts valuable insights, ideas, quotes, and references from content, emphasizing topics like human flourishing, AI, learning, and technology. Adapted from Fabric pattern `extract_wisdom_agents`.
---

# Extract Wisdom Agents

Adapted from [danielmiessler/fabric `extract_wisdom_agents`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/extract_wisdom_agents).

## When to Use

- Use when the `extract_wisdom_agents` Fabric workflow fits the task.
- Upstream pattern: [extract_wisdom_agents](https://github.com/danielmiessler/fabric/tree/main/data/patterns/extract_wisdom_agents)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/extract_wisdom_agents/system.md`
