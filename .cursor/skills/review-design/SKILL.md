---
name: review-design
description: Reviews and analyzes architecture design, focusing on clarity, component design, system integrations, security, performance, scalability, and data management. Adapted from Fabric pattern `review_design`.
---

# Review Design

Adapted from [danielmiessler/fabric `review_design`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/review_design).

## When to Use

- Use when the `review_design` Fabric workflow fits the task.
- Upstream pattern: [review_design](https://github.com/danielmiessler/fabric/tree/main/data/patterns/review_design)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/review_design/system.md`
