...
description: Extracts all valuable, insightful, and thought-provoking information from content, focusing on topics like human flourishing, AI, learning, and technology. Adapted from Fabric pattern `extract_wisdom_dm`.
---

# Extract Wisdom Dm

Adapted from [danielmiessler/fabric `extract_wisdom_dm`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/extract_wisdom_dm).

## When to Use

- Use when the `extract_wisdom_dm` Fabric workflow fits the task.
- Upstream pattern: [extract_wisdom_dm](https://github.com/danielmiessler/fabric/tree/main/data/patterns/extract_wisdom_dm)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/extract_wisdom_dm/system.md`
