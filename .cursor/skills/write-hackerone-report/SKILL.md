...
description: Generates concise, clear, and reproducible bug bounty reports, detailing vulnerability impact, steps to reproduce, and exploit details for triagers. Adapted from Fabric pattern `write_hackerone_report`.
---

# Write Hackerone Report

Adapted from [danielmiessler/fabric `write_hackerone_report`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/write_hackerone_report).

## When to Use

- Use when the `write_hackerone_report` Fabric workflow fits the task.
- Upstream pattern: [write_hackerone_report](https://github.com/danielmiessler/fabric/tree/main/data/patterns/write_hackerone_report)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/write_hackerone_report/system.md`
