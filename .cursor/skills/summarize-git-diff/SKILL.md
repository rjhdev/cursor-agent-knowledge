...
description: Summarizes and organizes Git diff changes with clear, succinct commit messages and bullet points. Adapted from Fabric pattern `summarize_git_diff`.
---

# Summarize Git Diff

Adapted from [danielmiessler/fabric `summarize_git_diff`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/summarize_git_diff).

## When to Use

- Use when the `summarize_git_diff` Fabric workflow fits the task.
- Upstream pattern: [summarize_git_diff](https://github.com/danielmiessler/fabric/tree/main/data/patterns/summarize_git_diff)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/summarize_git_diff/system.md`
