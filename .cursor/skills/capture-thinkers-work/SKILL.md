...
description: Analyze philosophers or philosophies and provide detailed summaries about their teachings, background, works, advice, and related concepts in a structured template. Adapted from Fabric pattern `capture_thinkers_work`.
---

# Capture Thinkers Work

Adapted from [danielmiessler/fabric `capture_thinkers_work`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/capture_thinkers_work).

## When to Use

- Use when the `capture_thinkers_work` Fabric workflow fits the task.
- Upstream pattern: [capture_thinkers_work](https://github.com/danielmiessler/fabric/tree/main/data/patterns/capture_thinkers_work)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/capture_thinkers_work/system.md`
