---
name: improve-prompt
description: Improves an LLM/AI prompt by applying expert prompt writing strategies for better results and clarity. Adapted from Fabric pattern `improve_prompt`.
---

# Improve Prompt

Adapted from [danielmiessler/fabric `improve_prompt`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/improve_prompt).

## When to Use

- Use when the `improve_prompt` Fabric workflow fits the task.
- Upstream pattern: [improve_prompt](https://github.com/danielmiessler/fabric/tree/main/data/patterns/improve_prompt)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/improve_prompt/system.md`
