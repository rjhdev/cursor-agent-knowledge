...
description: Extract enforceable rules from codebases to prevent common mistakes and ensure consistency. Adapted from Fabric pattern `create_golden_rules`.
---

# Create Golden Rules

Adapted from [danielmiessler/fabric `create_golden_rules`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/create_golden_rules).

## When to Use

- Use when the `create_golden_rules` Fabric workflow fits the task.
- Upstream pattern: [create_golden_rules](https://github.com/danielmiessler/fabric/tree/main/data/patterns/create_golden_rules)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/create_golden_rules/system.md`
