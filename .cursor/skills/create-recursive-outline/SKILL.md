...
description: Breaks down complex tasks or projects into manageable, hierarchical components with recursive outlining for clarity and simplicity. Adapted from Fabric pattern `create_recursive_outline`.
---

# Create Recursive Outline

Adapted from [danielmiessler/fabric `create_recursive_outline`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/create_recursive_outline).

## When to Use

- Use when the `create_recursive_outline` Fabric workflow fits the task.
- Upstream pattern: [create_recursive_outline](https://github.com/danielmiessler/fabric/tree/main/data/patterns/create_recursive_outline)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/create_recursive_outline/system.md`
