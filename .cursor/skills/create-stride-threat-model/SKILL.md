...
description: Create a STRIDE-based threat model for a system design, identifying assets, trust boundaries, data flows, and prioritizing threats with mitigations. Adapted from Fabric pattern `create_stride_threat_model`.
---

# Create Stride Threat Model

Adapted from [danielmiessler/fabric `create_stride_threat_model`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/create_stride_threat_model).

## When to Use

- Use when the `create_stride_threat_model` Fabric workflow fits the task.
- Upstream pattern: [create_stride_threat_model](https://github.com/danielmiessler/fabric/tree/main/data/patterns/create_stride_threat_model)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/create_stride_threat_model/system.md`
