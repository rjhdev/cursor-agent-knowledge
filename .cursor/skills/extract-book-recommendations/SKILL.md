...
description: Extracts and outputs 50 to 100 practical, actionable recommendations from a book's content. Adapted from Fabric pattern `extract_book_recommendations`.
---

# Extract Book Recommendations

Adapted from [danielmiessler/fabric `extract_book_recommendations`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/extract_book_recommendations).

## When to Use

- Use when the `extract_book_recommendations` Fabric workflow fits the task.
- Upstream pattern: [extract_book_recommendations](https://github.com/danielmiessler/fabric/tree/main/data/patterns/extract_book_recommendations)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/extract_book_recommendations/system.md`
