...
description: Efficiently extract and organize key details from cybersecurity breach articles, focusing on attack type, vulnerable components, attacker and target info, incident details, and remediation steps. Adapted from Fabric pattern `analyze_incident`.
---

# Analyze Incident

Adapted from [danielmiessler/fabric `analyze_incident`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/analyze_incident).

## When to Use

- Use when the `analyze_incident` Fabric workflow fits the task.
- Upstream pattern: [analyze_incident](https://github.com/danielmiessler/fabric/tree/main/data/patterns/analyze_incident)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/analyze_incident/system.md`
