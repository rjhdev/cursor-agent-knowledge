...
description: Extracts and analyzes recurring, surprising, and insightful patterns from input, providing detailed analysis and advice for builders. Adapted from Fabric pattern `extract_patterns`.
---

# Extract Patterns

Adapted from [danielmiessler/fabric `extract_patterns`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/extract_patterns).

## When to Use

- Use when the `extract_patterns` Fabric workflow fits the task.
- Upstream pattern: [extract_patterns](https://github.com/danielmiessler/fabric/tree/main/data/patterns/extract_patterns)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/extract_patterns/system.md`
