...
description: Generates Git commands and commit messages for reflecting changes in a repository, using conventional commits and providing concise shell commands for updates. Adapted from Fabric pattern `create_git_diff_commit`.
---

# Create Git Diff Commit

Adapted from [danielmiessler/fabric `create_git_diff_commit`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/create_git_diff_commit).

## When to Use

- Use when the `create_git_diff_commit` Fabric workflow fits the task.
- Upstream pattern: [create_git_diff_commit](https://github.com/danielmiessler/fabric/tree/main/data/patterns/create_git_diff_commit)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/create_git_diff_commit/system.md`
