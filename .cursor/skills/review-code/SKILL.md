---
name: review-code
description: Performs a comprehensive code review, providing detailed feedback on correctness, security, and performance. Adapted from Fabric pattern `review_code`.
---

# Review Code

Adapted from [danielmiessler/fabric `review_code`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/review_code).

## When to Use

- Use when the `review_code` Fabric workflow fits the task.
- Upstream pattern: [review_code](https://github.com/danielmiessler/fabric/tree/main/data/patterns/review_code)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/review_code/system.md`
