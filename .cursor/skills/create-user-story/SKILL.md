...
description: Writes concise and clear technical user stories for new features in complex software programs, formatted for all stakeholders. Adapted from Fabric pattern `create_user_story`.
---

# Create User Story

Adapted from [danielmiessler/fabric `create_user_story`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/create_user_story).

## When to Use

- Use when the `create_user_story` Fabric workflow fits the task.
- Upstream pattern: [create_user_story](https://github.com/danielmiessler/fabric/tree/main/data/patterns/create_user_story)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/create_user_story/system.md`
