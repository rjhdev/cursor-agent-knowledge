...
description: Extracts surprising, insightful, and interesting information from content, categorizing it into sections like summary, ideas, quotes, facts, references, and recommendations. Adapted from Fabric pattern `extract_article_wisdom`.
---

# Extract Article Wisdom

Adapted from [danielmiessler/fabric `extract_article_wisdom`](https://github.com/danielmiessler/fabric/tree/main/data/patterns/extract_article_wisdom).

## When to Use

- Use when the `extract_article_wisdom` Fabric workflow fits the task.
- Upstream pattern: [extract_article_wisdom](https://github.com/danielmiessler/fabric/tree/main/data/patterns/extract_article_wisdom)
- Raw `system.md`: `https://raw.githubusercontent.com/danielmiessler/fabric/main/data/patterns/extract_article_wisdom/system.md`
